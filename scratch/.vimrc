...
iab binary    binary
iab Binary    Binary
iab binaries  binaries
iab Binaries  Binaries
iab character  character
iab Character  Character
iab characters characters
iab Characters Characters
iab example   example
iab Example   Example
iab examples  examples
iab Examples  Examples
iab should    should
iab Should    Should
iab separate  separate
iab Separate  Separate
iab phone      phone
iab Phone      Phone
...
" hi Comment ctermfg=darkcyan guifg=cyan
 ...
 hi Error ctermbg=darkred ctermfg=white guibg=red guifg=white
 hi search  ctermfg=white ctermbg=red guifg=white guibg=red
 hi String ctermfg=darkred ctermbg=black guifg=red guibg=black
 hi Number ctermfg=darkred guifg=red
 ...
 hi StatusLineNC ctermbg=black  ctermfg=blue guibg=black guifg=blue
